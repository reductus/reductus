...
def _generate_transmission(in_beam, empty_beam, integration_box=None, auto_integrate=True, margin=5):
    ...
    result = Parameters(OrderedDict([
        ...
        ('sample.uuid', in_beam.metadata['sample.GroupID']),
        ('sample.localid', in_beam.metadata['sample.localID']),
        ('reduction.openbeam', empty_beam.metadata['sample.description']),
        ('reduction.openbeam_file', empty_beam.metadata['run.filename']),
        ('reduction.openbeam_uuid', empty_beam.metadata['sample.GroupID']),
        ('reduction.openbeam_localid', empty_beam.metadata['sample.localID']),
